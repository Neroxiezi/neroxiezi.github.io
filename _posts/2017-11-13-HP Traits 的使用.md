...
date:   2017-11-13 12:03:02 +0800
author: "南丞"
desc: "php不像C++一样，是多继承语言，它是一种单继承语言，如果有时我们需要继承多个类怎么办？这个时候Traits就上场了，我们仅仅需要在类中用use声明多个trait，这样当前类中的同名方法覆盖trait，而trait又覆盖基类中的同名方法，属性也是一样的。"
